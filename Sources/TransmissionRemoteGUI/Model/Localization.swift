...
let englishStrings: [String: String] = [
    ...
    "sikertelen": "failed",
    "Szabály": "Rule",
    "Szabály bekapcsolva": "Rule enabled",
    "Ha a": "If the",
    "Akkor": "Then",
    "tracker-host": "tracker host",
    "címke": "label",
    "név-minta": "name pattern",
    "tracker": "tracker",
    "név": "name",
    "arány": "ratio",
    "üresjárat": "idle",
    "leállítás": "stop",
    "nincs akció": "no action",
    "Seed arány": "Seed ratio",
    "Leállítás üresjárat után (perc)": "Stop after idle (minutes)",
    "Üresjárati limit (perc)": "Idle limit (minutes)",
    "Feltöltési korlát (KB/s)": "Upload limit (KB/s)",
    "Letöltési korlát (KB/s)": "Download limit (KB/s)",
    "Feltöltési korlát": "Upload limit",
    "Letöltési korlát": "Download limit",
    "Címke hozzáadása": "Add label",
    "Azonnali leállítás": "Stop immediately",
    "Mit változtatna?": "What would change?",
    "Mit változtatna": "What would change",
    "Torrent": "Torrent",
    "Változás": "Change",
    "Alkalmazás": "Apply",
    "Egyetlen torrenten sem változna semmi.": "Nothing would change on any torrent.",
    "Nem sikerült ellenőrizni a változásokat.": "Could not check for changes.",
    ...
    // Per-torrent limit
    "Sebességkorlát (erre a torrentre)": "Speed limit (this torrent)",
    "Alkalmaz": "Apply",
    // Labels / categories
    "Címkék": "Labels",
    "Új címke": "New label",
    ...
    "Kliens-tanúsítvány (mTLS, opcionális)": "Client certificate (mTLS, optional)",
    ".p12 fájl útvonala": ".p12 file path",
    "Tallózás…": "Browse…",
    "Tanúsítvány jelszava": "Certificate password",
    // RSS auto-downloader
    "RSS auto-letöltő": "RSS auto-downloader",
    "Automatikus letöltés bekapcsolása": "Enable automatic downloading",
    "Hírcsatornák (feed-ek)": "Feeds",
    "Nincs feed. Adj hozzá egyet lentebb.": "No feeds. Add one below.",
    "Feed URL": "Feed URL",
    "Szabályok (cím-szűrő)": "Rules (title filter)",
    "Ha egy tétel címe illik egy aktív szabályra, automatikusan letöltődik. Szöveg = tartalmazás; /minta/ = regex.": "If an item's title matches an active rule, it's downloaded automatically. Plain text = contains; /pattern/ = regex.",
    "Új szabály (pl. 1080p vagy /S0[12]E../)": "New rule (e.g. 1080p or /S0[12]E../)",
    "Frissítés most": "Check now",
    "Ellenőrzés 15 percenként": "Checks every 15 minutes",
    // Statisztika panel
